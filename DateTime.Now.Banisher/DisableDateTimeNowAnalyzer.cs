...
namespace DateTimeNow.Now.Banisher
{
    ...
    public class DisableDateTimeNowAnalyzer : DiagnosticAnalyzer
    {
        ...
        private static readonly LocalizableString Description = new LocalizableResourceString(nameof(Resources.DateTimeAnalyzerDescription), Resources.ResourceManager, typeof(Resources));
        private static readonly LocalizableString MessageFormat = new LocalizableResourceString(nameof(Resources.DateTimeAnalyzerMessageFormat), Resources.ResourceManager, typeof(Resources));
